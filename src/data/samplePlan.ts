...
export const SAMPLE_PLAN: FloorPlan = {
  ...
  openings: [
    // 현관 출입문 (남벽)
    { id: 'o-entry', wallId: 'w-s', type: 'entry', offset: 5900, width: 1100, height: 2100, sill: 0 },
    // 안방 문 (안방 남벽)
    { id: 'o-m1', wallId: 'i-master-s', type: 'door', offset: 3500, width: 850, height: 2050, sill: 0 },
    // 방2 문 (방2 동벽)
    { id: 'o-m2', wallId: 'i-bed2-w', type: 'door', offset: 900, width: 800, height: 2050, sill: 0 },
    // 욕실 문 (욕실 남벽)
    { id: 'o-bath', wallId: 'i-bath-s', type: 'door', offset: 700, width: 750, height: 2000, sill: 0 },
    // 창문들
    { id: 'o-win-master', wallId: 'w-n', type: 'window', offset: 1300, width: 2000, height: 1500, sill: 900 },
    { id: 'o-win-bed2', wallId: 'w-w', type: 'window', offset: 1400, width: 1600, height: 1400, sill: 950 },
    { id: 'o-win-living-s', wallId: 'w-s', type: 'window', offset: 1800, width: 4200, height: 1600, sill: 500 },
    { id: 'o-win-living-e', wallId: 'w-e', type: 'window', offset: 2600, width: 2200, height: 1500, sill: 800 },
    { id: 'o-win-bath', wallId: 'i-bath-e', type: 'window', offset: 800, width: 700, height: 600, sill: 1500 },
  ],
  rooms: [
    {
      id: 'r-master',
